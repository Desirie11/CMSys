    ...
    public class TextWriter
    {
        ...
        public static void GetInfoFromUser()
        {
            ...
            if (PackageOption == 1)
            {
                ...
                string path = @"C:\Users\MyPC\source\repos\CMSys\DataLayer\Reciept.txt";
                ...
                //           sw.Write(contents); 
                File.AppendAllText(@"C:\Users\MyPC\source\repos\CMSys\DataLayer\AllPickupRequest.txt", File.ReadAllText(@"C:\Users\MyPC\source\repos\CMSys\DataLayer\Reciept.txt"));
            }
        ...
        public static void ViewAllPickupRequest()
        {

            String filePath = @"C:\Users\MyPC\source\repos\CMSys\DataLayer\AllPickupRequest.txt";
            //String[] lines = File.
        ...
        public static void GetQueryFromUser()
        {
            ...
            string path = @"C:\Users\MyPC\source\repos\CMSys\DataLayer\Query.txt";

            File.WriteAllText(path, "Name: " + name + "\n\n" + "Email: " + email + "\n\n" + "Phone number: " + "\n\n" + number3 + "\n\n" + "Query: " + Query + "\n");
            File.AppendAllText(@"C:\Users\MyPC\source\repos\CMSys\DataLayer\AllQuery.txt", File.ReadAllText(path));

        }

        public static void ViewPickUpRequest()
        {
            String filePath = @"C:\Users\MyPC\source\repos\CMSys\DataLayer\Reciept.txt";
            //String[] lines = File.
        ...
        public static void ViewAllQueries()
        {

            String filePath = @"C:\Users\MyPC\source\repos\CMSys\DataLayer\AllQuery.txt";
            //String[] lines = File.
        ...
        public static void AddnewAgent()
        {
            ...
            string path = @"C:\Users\MyPC\source\repos\CMSys\DataLayer\AgentDetails.txt";
        ...
        public static void AssignCourier()
        {
            ...
            string path = @"C:\Users\MyPC\source\repos\CMSys\DataLayer\CourierDetails.txt";
            ...
            File.AppendAllText(@"C:\Users\MyPC\source\repos\CMSys\DataLayer\CourierDetails.txt", File.ReadAllText(@"C:\Users\MyPC\source\repos\CMSys\DataLayer\Reciept.txt"));
        }
    }
}
